...
//ESTE ES EL APARTADO OTROS DOCUMENTOS 
const EnviarDocs = ({ show, onClose, asesoriaId }) => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const response = await fetch(
        ...
        }/asesoramiento-documentos/crear/${asesoriaId}`,
        {
          method: "POST",
          body: formData,
        }
    ...
    >
      <div className="bg-[#F8F7F7] flex flex-col gap-4 rounded-2xl shadow-2xl w-full max-w-lg p-6 relative max-h-[90vh] overflow-y-auto transition-all duration-300">
        ...
        <div className="flex justify-center">
          <h2 className="text-xl font-medium">Subir Documentos Extra</h2>
        </div>
