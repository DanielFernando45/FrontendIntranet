            ...
            <React.Fragment key={contrato.id_asesoramiento}>
              <div className={`flex justify-between px-1 rounded-md ${index % 2 === 0 ? 'bg-[#E9E7E7]' : ''} py-2`}>
                ...
                <div className='flex w-[200px] justify-between px-3'>
                  ...
                  <button
                    className='bg-[#1C1C34] rounded-lg p-[2px] size-7 flex items-center justify-center'
      ...
      {eliminando && (
        <div className='fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50'>
          <div className='bg-white p-6 rounded-lg shadow-lg w-96'>
            <h2 className='text-xl font-semibold mb-4'>¿Estás seguro de eliminar esta asesoría?</h2>
            ...
            <div className='flex justify-end space-x-4'>
              ...
              <button
                onClick={() => {
                  // Lógica para eliminar la asesoría
                  setEliminando(false);
                }}
