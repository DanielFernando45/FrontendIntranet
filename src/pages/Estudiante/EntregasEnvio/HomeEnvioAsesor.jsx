...
const HomeEnvioAsesor = ({ idAsesoramiento }) => {
    ...
    <div className="flex flex-col ">
      {loading ? (
        ...
        <>
          ...
          <div className="flex justify-between text-[#495D72] font-medium  rounded-md">
            <div className="w-[200px] flex text-[8px] sm:text-[12px] lg:text-[14px]">
              Título
            </div>
            <div className="w-[102px] justify-center hidden text-[8px] sm:text-[12px] lg:text-[14px] 1xl:flex">
              Estado
            </div>
            <div className="w-[100px] flex justify-center text-[8px] sm:text-[12px] lg:text-[14px]">
              Fecha
            </div>
            <div className="w-[250px] justify-center hidden md:flex text-[8px] sm:text-[12px] lg:text-[14px]">
              Archivo
            </div>
            <div className="w-[100px] rounded-md px-3 flex justify-center text-[8px] sm:text-[12px] lg:text-[14px]">
              Descargas
            </div>
          </div>
          ...
          <div
            className="overflow-y-auto max-h-[170px] scroll-smooth scrollbar-thin scrollbar-thumb-gray-400 scrollbar-track-gray-100"
                ...
                <React.Fragment key={envio.id_asunto || index}>
                  ...
                  {openItems[index] && hasDocuments && (
                    <div className="flex flex-col md:flex-row justify-between text-[#2B2829] font-normal items-center py-2 border-b text-xs md:text-base">
                      <div className="flex-1 flex text-[8px] sm:text-[12px] lg:text-[14px] ">{envio.asunto.cliente}</div>
                      <div className="hidden lg:block text-white bg-[#353563] rounded px-3 text-[8px] sm:text-[12px] lg:text-[14px]">
                        {envio.estado}
                      </div>
                      <div className="flex-1 flex justify-center text-[8px] sm:text-[12px] lg:text-[14px]">
                        {formatDate(envio.fecha)}
                      </div>
                      <div className="flex-1 flex flex-col gap-1 justify-center font-semibold text-[#495D72] text-[8px] sm:text-[12px] lg:text-[14px]">
...
export default HomeEnvioAsesor