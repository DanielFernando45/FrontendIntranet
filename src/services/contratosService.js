...
const CrearContrato = async (idAsesoramiento, contratoData) => {
    try {
        ...
        const response = await api.post(`/contrato/crear-contrato/${idAsesoramiento}`, contratoData);
        return response.data; // Aquí accedemos directamente a 'data'
    } catch (error) {
...
const eliminarContrato = async (idContrato) => {
    try {
        const response = await api.delete(`/contrato/eliminar-contrato/${idContrato}`);
        return response.data; // Aquí accedemos directamente a 'data'
    } catch (error) {
...
const actualizarContrato = async (idContrato, contratoData) => {
    try {
        const response = await api.put(`/contrato/editar-contrato/${idContrato}`, contratoData);
        return response.data; // Aquí accedemos directamente a 'data'
    }
    catch (error) {
